...
public class JColorPanel extends JPanel implements MouseListener,MouseMotionListener{
    ...
    public JColorPanel(ZirkelFrame zf,JPaletteManager jpm) {
        ZF=zf;
        JPM=jpm;
        me=this;
        xx=-1;yy=-1;
...
//        Pal=cchooser.getPalettes()[4];
     ...
     public String Loc(String s){
        return JPM.MW.Strs.getString("palette.colors."+s);
    }
...
//        }
    ...
    private class onlycolors extends JPanel{
        ...
        public void paintComponent(java.awt.Graphics g){
            ...
            Color mycolor=Global.getParameter("colorbackground",new Color(231,238,255));
