...
public class AngleObject extends ConstructionObject
    ...
    protected int DisplaySize=SMALL;
    ...
    public AngleObject(Construction c,
        ...
        double ll=Math.sqrt(xx*xx+yy*yy);
        xx=xx/ll;
        yy=yy/ll;
...
//        }
        return JGlobals.getLocaleNumber(A/Math.PI*180, "angles");
    }
            ...
            if (Filled) {
                if (DisplaySize==RECT) {
                    ...
                    if (Math.abs(DA-90)<0.0000001) {
                        ...
                        g.fillArc(c1, r1, 2*R, 2*R, A1/Math.PI*180, DA, Selected||getColorType()!=THIN, getColorType()!=THICK, true, this);
                    }
                }
