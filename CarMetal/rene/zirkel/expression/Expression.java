...
class FindObjectExpression extends ObjectExpression
    ...
    public ConstructionObject getObject() {
        ...
        if (O!=null&&O.getConstruction()==C&&O.isInConstruction()&&O.getName().equals(Name)) {
            return O;
        }
    ...
    public static BasicExpression scan(ExpressionText t, boolean quotes)
        ...
        while (true) {
            ...
            if (!(Character.isLetterOrDigit(c)||c=='\\'||c=='\''||(quotes&&c!='\"'&&c!=0)||(quotes&&c==' '))) {
                break;
            }
            b.append(c);
            t.advance(quotes);
        ...
        if (o==null) {
            ...
            if (o==null) {
                if (t.getConstruction().loading()) {
                    ...
                    throw new ConstructionException(Zirkel.name("exception.notfound")+" ("+s+")");
                }
            }
            //System.out.println("---");
...
class FunctionExpression extends BasicExpression {
    ...
    final static String Functions[]={"sin", "cos", "tan", "arcsin", "arccos", "arctan",
        ...
        "sinhyp", "coshyp", "z", "simulate", "inside", "random"
    };
    final static int NX=10,  NY=11,  ND=14,  NA=15,  NS=19,  NSUM=22,  NIF=23,  NINT=26,  NZERO=27,  NDIFF=28,  NMIN=29,  NMAX=30,  NLENGTH=31,  NZ=40,  NSIM=41,  NINSIDE=42,  NRANDOM=43;
    ...
    public static BasicExpression scan(ExpressionText t, String name)
        ...
        if (f<0) {
            ...
            if (o!=null&&(o instanceof FunctionObject||o instanceof UserFunctionObject)&&!(o==t.getObject())&&!t.getConstruction().dependsOn(o, t.getObject())) {
                if (t.next()!='(') {
            ...
            throw new ConstructionException(Zirkel.name("exception.function")+" ("+name+")");
        }
        if (t.next()!='(') {
            throw new ConstructionException(Zirkel.name("exception.parameter"));
        }
        ...
        if (f==NX||f==NY||f==NZ) {
            if (e instanceof FindObjectExpression) {
                ...
                throw new ConstructionException(Zirkel.name("exception.parameter")+" ("+Functions[f]+")");
            }
        } else if (f==ND) {
            if (t.next()!=',') {
                e=new DExpression(e);
                ...
                if (((e instanceof ObjectExpression&&
                        ((ObjectExpression) e).getObject() instanceof PointObject)||e instanceof FindObjectExpression)&&
                        ((ee instanceof ObjectExpression&&
                        ((ObjectExpression) ee).getObject() instanceof PointObject)||ee instanceof FindObjectExpression)) {
            ...
            if (((e instanceof ObjectExpression&&
                    ...
                    ((ObjectExpression) eee).getObject() instanceof PointObject)||eee instanceof FindObjectExpression)) {
            ...
            if (!(e instanceof ObjectExpression)) {
                ...
                boolean function=((ObjectExpression) e).getObject() instanceof Evaluator||((ObjectExpression) e).getObject() instanceof TrackObject;
            ...
            if (((e instanceof ObjectExpression&&
                    ((ObjectExpression) e).getObject() instanceof PointObject)||e instanceof FindObjectExpression)&&
                    ((ee instanceof ObjectExpression&&
                    ((ObjectExpression) ee).getObject() instanceof InsideObject)||ee instanceof FindObjectExpression)) {
                e=new FunctionExpression(f, e, ee);
            } else {
                throw new ConstructionException(Zirkel.name("exception.parameter")+" ("+Functions[f]+")");
            }
    ...
    public double getPointLineX(int n)
            throws ConstructionException {
        PointObject p;
        ...
        public double getPointLineY(int n)
            throws ConstructionException {
        PointObject p;
        PrimitiveLineObject l;
        try {
...
class RandomExpression extends FunctionExpression {
    ...
    public RandomExpression(BasicExpression e, BasicExpression ee) {
        super(NRANDOM, e, ee);
    }

    public RandomExpression(BasicExpression e) {
        super(NRANDOM, e);
    }
    ...
    public double getValue() throws ConstructionException {
        if (NParams>1) {
            try {
                double r=E[0].getValue();
                double p=E[1].getValue();
...
abstract class ElementaryExpression extends BasicExpression {
    ...
    public static BasicExpression scan(ExpressionText t)
            throws ConstructionException {
        try {
            BasicExpression E=DoubleExpression.scan(t);
            return E;
        } catch (Exception e) {
        }
        try {
...
class CompareExpression extends BasicExpression {
    ...
    BasicExpression E1, E2;
    int Operator;
    final static int LESS=1,  LESSEQUAL=2,  GREATER=3,  GREATEREQUAL=4,  EQUAL=5,  ABOUTEQUAL=6;
...
//                return logical(E1.getValue()==E2.getValue());
                return logical(
                        Math.abs(E1.getValue()-E2.getValue())<1e-14);
            case ABOUTEQUAL:
                return logical(
