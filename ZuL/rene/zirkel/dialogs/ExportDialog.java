...
{	ZirkelFrame ZF;
	...
	Checkbox BackgroundColor,AppletColor,Job,Comment,SaveSolution,LinkSolution,
		JumpSolution,Digits,Colors,Background,Popup,Zoom,RestrictedMove,CopyJar;
	Panel CP;
	Choice Style;
	boolean OK=false;
	IconBar IBa,IBb;
	...
	{	super(zf,Zirkel.name("export.title"),true);
		...
		p.add(new MyLabel(""));
		p.add(CopyJar=
			new CheckboxAction(this,Zirkel.name("export.copyjar")));
		CopyJar.setState(false);
