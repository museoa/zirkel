...
<CaR>
<Macro Name="แมโครพื้นฐาน/แบ่งครึ่งมุมด้วยเส้นตรง (8)">
...
<Comment>
<P>แบ่งครึ่งมุมของมุม P1P2P3 ด้วยเส้นตรง.</P>
</Comment>
<Objects>
...
<Macro Name="แมโครพื้นฐาน/แบ่งครึ่งมุมด้วยรังสี (9)">
<Parameter name="P1">Point on first leg of angle</Parameter>
<Parameter name="P2">Vertex of angle</Parameter>
<Parameter name="P3">Point on second leg of angle</Parameter>
<Comment>
<P>แบ่งครึ่งมุมของมุม P1P2P3 ด้วยรังสี.</P>
</Comment>
<Objects>
...
<Macro Name="แมโครพื้นฐาน/แกนพิกัด">
<Parameter name="P1">Zentrum</Parameter>
<Comment>
<P>ปรับปรุงแกนพิกัดเดิมที่ใช้ในการสร้าง
คลิกบนพิกัด (0,0)!</P>
</Comment>
<Objects>
...
<Macro Name="แมโครพื้นฐาน/เส้นตั้งฉากที่แบ่งครึ่งเส้นตรง (1)">
<Parameter name="P1">First endpoint of segment</Parameter>
<Parameter name="P2">Second endpoint of segment</Parameter>
<Comment>
<P>เส้นตั้งฉากที่แบ่งครึ่งเส้นตรงจากจุด P1 และจุด  P2.</P>
</Comment>
<Objects>
...
<Macro Name="แมโครพื้นฐาน/สะท้อนกับเส้นตรง (5)">
...
<Macro Name="แมโครพื้นฐาน/หมุน (10)">
<Parameter name="P1">Point on first leg of angle</Parameter>
<Parameter name="P2">Vertex of angle</Parameter>
<Parameter name="P3">Point on second leg of angle</Parameter>
...
<Comment>
<P>หมุนจุด P รอบ Q กับมุม  ABC.</P>
</Comment>
<Objects>
...
<Macro Name="แมโครพื้นฐาน/Shift (12)">
...
<Macro Name="แมโครพื้นฐาน/สไลเดอร์">
<Parameter name="P1">Slider Start</Parameter>
<Parameter name="P2">Slider End</Parameter>
<Comment>
<P>สไลเดอร์ที่กำหนดในช่วงปิด [a,b].โดยกำหนดค่าจากผู้ใช้
(เปลี่ยนชื่อ expression). a และ b จะถามขึ้นขณะเรียกใช้แมโคร.</P>
</Comment>
<Objects>
