...
<CaR version="8.77">
<Macro Name="Padrão/Bissetriz Perpendicular (1)">
<Parameter name="P1">P1</Parameter>
<Parameter name="P2">P2</Parameter>
<Comment>
<P>Linha média perpendicular de P1 e P2.</P>
</Comment>
<Objects>
...
<Line name="g1" n="6" target="true" from="S1" to="S2">Perpendicular média de S1 e S2</Line>
</Objects>
</Macro>
<Macro Name="Padrão/Projeção de Ponto para Linha (2)">
<Parameter name="g1">g</Parameter>
<Parameter name="P3">P</Parameter>
<Comment>
<P>Projeta P na linha g.</P>
</Comment>
<Objects>
...
<Macro Name="Padrão/Reflexão em um Círculo (6)">
<Parameter name="k">k</Parameter>
<Parameter name="P">P</Parameter>
<Comment>
<P>Reflete P no círculo k.</P>
</Comment>
<Objects>
...
<Macro Name="Padrão/Reflexão em um Ponto (7)">
<Parameter name="P1">O</Parameter>
<Parameter name="P2">P</Parameter>
<Comment>
<P>Reflexão de P no ponto O.</P>
</Comment>
<Objects>
...
<Macro Name="Padrão/Reflexão em uma Linha (5)">
<Parameter name="g1">g</Parameter>
<Parameter name="P3">P</Parameter>
<Comment>
<P>Refletir P em g.</P>
...
<Comment>
<P>Rotaciona um ponto P ao redor de Q com ângulo ABC.</P>
</Comment>
<Objects>
...
<Angle name="w1" n="5" color="1" hidden="super" first="P5" root="P4" fixedangle="true" fixed="a(P1,P2,P3)">Fester Winkel P5 - P4 mit Größe a(P1,P2,P3)</Angle>
...
<Macro Name="Padrão/Rotação com ângulo (11)">
<Parameter name="P1">Center of rotation</Parameter>
<Parameter name="P2">Rotating point</Parameter>
<Comment>
<P>Rotaciona um ponto P ao redor de Q com dado ângulo.</P>
</Comment>
<Objects>
...
<Angle name="w1" n="2" hidden="super" first="P2" root="P1" fixedangle="true" fixed="16">Fester Winkel P2 - P1 mit Größe 16</Angle>
...
<Macro Name="Padrão/Ângulo Bissetriz com Semi-Reta (9)">
<Parameter name="P1">P1</Parameter>
<Parameter name="P2">P2</Parameter>
<Parameter name="P3">P3</Parameter>
<Comment>
<P>Ângulo Bissetriz de ângulo P1P2P3 como semi-reta.</P>
</Comment>
<Objects>
...
<Macro Name="Padrão/Ângulo Bissetriz como Linha (8)">
<Parameter name="P1">P1</Parameter>
<Parameter name="P2">P2</Parameter>
<Parameter name="P3">P3</Parameter>
<Comment>
<P>Ângulo bissetriz do ângulo P1P2P3 como linha.</P>
</Comment>
<Objects>
