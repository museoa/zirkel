...
<CaR>
<Macro Name="Προεπιλεγμένες μακροεντολές/Διχοτόμος Γωνίας ως Ευθεία (8)">
<Parameter name="P1">Σημείο στο πρώτο ευθύγραμμο τμήμα της γωνίας</Parameter>
<Parameter name="P2">Κορυφή της γωνίας</Parameter>
<Parameter name="P3">Σημείο στο δεύτερο ευθύγραμμο τμήμα της γωνίας</Parameter>
<Comment>
<P>Διχοτόμος Γωνίας που σχηματίζουν τα σημεία P1 P2 P3 ως Ευθεία.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Διχοτόμος Γωνίας ως Ημιευθεία (9)">
<Parameter name="P1">Σημείο στο πρώτο ευθύγραμμο τμήμα της γωνίας</Parameter>
<Parameter name="P2">Κορυφή της γωνίας</Parameter>
<Parameter name="P3">Σημείο στο δεύτερο ευθύγραμμο τμήμα της γωνίας</Parameter>
<Comment>
<P>Διχοτόμος Γωνίας που σχηματίζουν τα σημεία P1 P2 P3 ως Ημιευθεία.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Άξονες Συστήματος Συντεταγμένων">
<Parameter name="P1">Κέντρο</Parameter>
<Comment>
<P>Δημιουργεί τους Άξονες του Συστήματος Συντεταγμένων για χρήση στην κατασκευή.
Κάντε κλικ στο (0,0)!</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Μεσοκάθετος (1)">
<Parameter name="P1">Πρώτο ακραίο σημείο του ευθύγραμμου τμήματος</Parameter>
<Parameter name="P2">Δεύτερο ακραίο σημείο του ευθύγραμμου τμήματος</Parameter>
<Comment>
<P>Μεσοκάθετος που διέρχεται από το μέσο του ευθύγραμμου τμήματος των σημείων P1 και P2.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Προβολή Σημείου σε Ευθεία (2)">
<Parameter name="g1">Ευθεία στην οποία θα γίνει η προβολή</Parameter>
<Parameter name="P3">Σημείο για το οποίο θα δημιουργηθεί η προβολή</Parameter>
<Comment>
<P>Προβολή του σημείου Ρ στην ευθεία g.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Συμμετρία ως προς Κύκλο (6)">
<Parameter name="k">Κύκλος ως προς τον οποίο θα εφαρμοστεί η συμμετρία</Parameter>
<Parameter name="P">Σημείο για το οποίο θα δημιουργηθεί το συμμετρικό του σημείο</Parameter>
<Comment>
<P>Συμμετρικό σημείο του σημείου Ρ ως προς κύκλο k.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Συμμετρία ως προς Ευθεία (5)">
<Parameter name="g1">Ευθεία ως προς το οποίο θα εφαρμοστεί η συμμετρία</Parameter>
<Parameter name="P3">Σημείο για το οποίο θα δημιουργηθεί το συμμετρικό του σημείο</Parameter>
<Comment>
<P>Συμμετρικό σημείο του σημείου Ρ ως προς την ευθεία g.</P>
</Comment>
<Objects>
<Line name="g1" n="0" mainparameter="true">???</Line>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Συμμετρία ως προς Σημείο (7)">
<Parameter name="P1">Σημείο ως προς το οποίο θα εφαρμοστεί η συμμετρία</Parameter>
<Parameter name="P2">Σημείο για το οποίο θα δημιουργηθεί το συμμετρικό του σημείο</Parameter>
<Comment>
<P>Συμμετρικό σημείο του σημείου Ρ ως προς το σημείο O.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Περιστροφή (10)">
<Parameter name="P1">Σημείο στο πρώτο ευθύγραμμο τμήμα της γωνίας</Parameter>
<Parameter name="P2">Κορυφή της γωνίας</Parameter>
<Parameter name="P3">Σημείο στο δεύτερο ευθύγραμμο τμήμα της γωνίας</Parameter>
<Parameter name="P4">Σημείο ως προς το οποίο θα πραγματοποιηθεί η περιστροφή</Parameter>
<Parameter name="P5">Σημείο το οποίο θα περιστραφεί</Parameter>
<Comment>
<P>Περιστροφή του σημείου Ρ γύρω από το σημείο Q με γωνία ABC.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Περιστροφή με γωνία (11)">
<Parameter name="P1">Σημείο ως προς το οποίο θα πραγματοποιηθεί η περιστροφή</Parameter>
<Parameter name="P2">Σημείο το οποίο θα περιστραφεί</Parameter>
<Comment>
<P>Περιστροφή του σημείου Ρ γύρω από το σημείο Q με δοσμένη γωνία.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Μετατόπιση (12)">
<Parameter name="P1">Πρώτο σημείο καθορισμού της απόστασης της μετατόπισης</Parameter>
<Parameter name="P2">Δεύτερο σημείο καθορισμού της απόστασης της μετατόπισης</Parameter>
<Parameter name="P3">Σημείο το οποίο θα μετατοπιστεί</Parameter>
<Comment>
<P>Μετατόπιση του σημείου P σε απόσταση ίση με την απόσταση των σημείων A και B.</P>
</Comment>
<Objects>
...
<Macro Name="Προεπιλεγμένες μακροεντολές/Ολισθητής">
<Parameter name="P1">Σημείο εκκίνησης του ολισθητή</Parameter>
<Parameter name="P2">Σημείο τερματισμού του ολισθητή</Parameter>
<Comment>
<P>Ολισθητής που καθορίζει μια τιμή στο διάστημα [a,b]. Η τιμή μπορεί να χρησιμοποιηθεί αργότερα. 
Οι τιμές των a και b ζητούνται κατά τη διάρκεια εκτέλεσης της μακροεντολής.</P>
</Comment>
<Objects>
