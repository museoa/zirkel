...
{	PointObject P1=null,P2=null,P3=null;
	...
	{	if (!testTree(tree,"Angle")) return false;
		...
		if (tag.hasTrueParam("fixedangle") && !tag.hasParam("first"))
		{	FixedAngleObject o=new FixedAngleObject(c);
			try
